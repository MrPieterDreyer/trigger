...
2. **Genuinely quick** (e.g. single-file fix, typo, small config tweak): implement directly; run **`verification_commands`** from **`.trigger/trigger.json`**; show the change for user approval. No formal review pipeline.
