...
export async function createMilestone(projectRoot, options) {
...
export async function listMilestones(projectRoot) {
    const paths = new TriggerPaths(projectRoot);
...
export async function getMilestoneStatus(projectRoot, milestoneId) {
    const paths = new TriggerPaths(projectRoot);
